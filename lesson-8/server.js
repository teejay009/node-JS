...
// // we call for image here to show in our output
...
// const whitelist = ['https://www.yourdomain.com', 'http://127.0.0.1:3400', 'http://localhost:3000']
// const corsOptions = {
//     origin: (origin, callback) => {
//         if(whitelist.indexOf(origin) !== -1 || !origin) {
//             callback(null, true)
//         }else{
//             callback(new Error('Alahamdulila, there is Error'))
//         }
//     },
//     OptionasSuccessStatus: 200
// }

// app.use(cors(corsOptions))


// // to make index.html as the default
// // app.get('/',(req, res) =>{
// //     res.sendFile('/views/index.html', {root: __dirname})
// // })

// // an alternative to make index.html the home page
// // app.get('/',(req, res) =>{
// //     res.sendFile(path.join(__dirname,'views', 'index.html'))

// // })
// // another alternative to make index.html the home page
